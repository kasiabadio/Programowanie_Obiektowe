...
Samochod::Samochod() : pojemnosc_baku{100.0}
{
    poziom_paliwa = 10.0;
...
Samochod::Samochod(float _pojemnosc_baku, std::string _model) : pojemnosc_baku{_pojemnosc_baku},
                                                                model{_model}
{
    poziom_paliwa = 10.0;
    liczba_kilometrow = 100;
...
void Samochod::operator|=(int _liczba_kilometrow)
{
    this->liczba_kilometrow = _liczba_kilometrow;
}

void Samochod::operator,(int _pojemnosc_baku)
{
    this->pojemnosc_baku = _pojemnosc_baku;
}